...
Welcome to **Interpuls S.p.A.**.

**Interpuls S.p.A.** (“us”, “we”, or “our”) operates **https://mi-linerlens.milkrite-interpuls.com** (hereinafter referred to as **“Service”**).

Our Privacy Policy governs your visit to **https://mi-linerlens.milkrite-interpuls.com**, and explains how we collect, safeguard and disclose information that results from your use of our Service.
...
**SERVICE** means the https://mi-linerlens.milkrite-interpuls.com website operated by Interpuls S.p.A..
...
Interpuls S.p.A. uses the collected data for various purposes:
...
Interpuls S.p.A. will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organisation or a country unless there are adequate controls in place including the security of your data and other personal information.
...
0.2.3. to fulfill the purpose for which you provide the information;
...
0.3. the right to object. You have the right to object to our processing of your personal information;
...
export default function PrivacyPage() {
  const html = markdownToHtml(privacyMarkdown);
